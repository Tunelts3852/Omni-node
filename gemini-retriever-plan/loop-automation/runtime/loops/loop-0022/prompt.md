...
이전 루프 참조 경로:
- gemini-retriever-plan/loop-automation/runtime/loops/loop-0021

현재 루프 번호: 22
현재 루프 리포트 경로: gemini-retriever-plan/loop-automation/runtime/loops/loop-0022
...
5) 아래 파일을 모두 갱신하세요.
   - gemini-retriever-plan/loop-automation/runtime/loops/loop-0022/01_work_done.md
   - gemini-retriever-plan/loop-automation/runtime/loops/loop-0022/02_remaining_tasks.md
   - gemini-retriever-plan/loop-automation/runtime/loops/loop-0022/03_unresolved_errors.md
   - gemini-retriever-plan/loop-automation/runtime/loops/loop-0022/04_passed_runs.md
   - gemini-retriever-plan/loop-automation/runtime/loops/loop-0022/05_changed_files.md
   - gemini-retriever-plan/loop-automation/runtime/loops/loop-0022/06_next_loop_focus.md
6) 누적 상태 파일을 갱신하세요.
   - gemini-retriever-plan/loop-automation/runtime/state/CURRENT_STATUS.md
   - gemini-retriever-plan/loop-automation/runtime/state/CURRENT_REMAINING_TASKS.md
   - gemini-retriever-plan/loop-automation/runtime/state/CURRENT_UNRESOLVED_ERRORS.md
