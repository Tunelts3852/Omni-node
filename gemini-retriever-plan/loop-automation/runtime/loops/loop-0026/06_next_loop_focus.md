...
2. `guard_retry_timeline` 비-seed 표본 `110 -> 120+` 추가 누적
- 로컬+텔레그램 P3 smoke 반복으로 경보 드리프트(오탐/미탐) 추세 관측 구간 3차 확장

3. `120+` 누적 기준 readiness/bundle 강제 검증 재통과 확보
